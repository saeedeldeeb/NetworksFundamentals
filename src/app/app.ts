  ...
  sections: Section[] = [
    ...
    },
    {
      ...
      lessons: [
        ...
        { title: 'TCP Server with Node.js', path: '/section/5/10' },
        { title: 'TCP Server with C', path: '/section/5/11' },
        { title: 'Capturing with tcpdump', path: '/section/5/12' },
      ],
    },
    {
      id: 6,
      ...
      available: true,
      lessons: [
        { title: 'Introduction', path: '/section/6/1' },
        { title: 'DNS', path: '/section/6/2' },
        { title: 'TLS', path: '/section/6/3' },
        { title: 'HTTPS & Certificates', path: '/section/6/4' },
      ],
    },
    {
      id: 7,
      ...
      lessons: [
        ...
        { title: 'Layer 4 vs Layer 7 Load Balancing', path: '/section/7/10' },
        { title: 'Network Access Control for Databases', path: '/section/7/11' },
      ],
    },
